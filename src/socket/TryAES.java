...
/**
 * Utility class for encrypting/decrypting files. by: Michael Lones Minor
 * Revisions by Glenn Hall
 */
public class TryAES {
	 ...
	 */
	public TryAES() throws GeneralSecurityException {
	...
	/**
	 * Creates a new AES key A random AES key is generated to encrypt files. A
	 * key size (AES_Key_Size) of 256 bits is standard for AES
	 */
