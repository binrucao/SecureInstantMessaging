...
public class Client_thread {
	...
	public void createUI(String aeskey) {
		...
		f.add(ta, "Center");
		f.add(p, "South");
		Send sender = new Send(sock, this, aeskey);
	...
	public void createThread(String aeskey) {
		Recieve_C receiver = new Recieve_C(sock, this, aeskey);
		receiver.start();
	}
...
class Send implements ActionListener {
	private Client_thread client;
	private String aeskey;
	private Socket sock;
	String msgtoServerString;
	TextField tf;

	public Send(Socket sock, Client_thread client, String aeskey) {
		this.sock = sock;
		this.aeskey = aeskey;
		this.client = client;
	}// end constructor
...
class Recieve_C extends Thread {
	private Client_thread client;
	private Socket sock;
	private String aeskey;

	public Recieve_C(Socket sock, Client_thread client, String aeskey) {
		this.sock = sock;
		this.aeskey = aeskey;
		this.client = client;
	}
